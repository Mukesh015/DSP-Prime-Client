...
//     return (
//         <div
//             className={`relative border-4 ${tank.border === "red"
//                 ? "border-red-500"
//                 : "border-green-500"
//                 } bg-white rounded-md p-5`}
//         >

//             {/* ALERT INDICATOR (TOP LEFT) */}
//             {(tank.msg === "high_level" ||
//                 tank.msg === "low_level" ||
//                 tank.msg === "network_lag") && (
//                     <div className="absolute top-2 left-2 px-2 py-1 text-xs font-semibold rounded bg-red-100 text-red-700">
//                         {tank.msg === "high_level" && "High Level"}
//                         {tank.msg === "low_level" && "Low Level"}
//                         {tank.msg === "network_lag" && "Network Lag"}
//                     </div>
//                 )}
...
//             <div className="mt-3 text-base font-semibold space-y-1">
